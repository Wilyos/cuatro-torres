...
const HeroSection = () => {
  return (
    <section className='relative min-h-[300px] md:h-screen bg-gradient-to-b from-blue-800 to-blue-800 flex xl:flex-row flex-col-reverse items-center justify-between lg:px-24 px-10 overflow-hidden pb-2 mb-5 md:pb-2'>
